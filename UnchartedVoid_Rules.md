...
- **Tokens/Markers:**  
  - Glass beads (or similar) to track various types of progress and damage.
  - Paper and pencil, or a 20-sided dice, to keep the score.
...
- At the end of this phase, there will be a line of 10 locations with two manufacts each
...
- **Move Ships:**  
  ...
  - Ships may bring Personnel and cargo with them. There's no limit to how many Personnel they can carry, however they can only carry cargo with size ≤ the ship's Hold)
...
- Some Ships can land on Planets; others allow Personnel to disembark onto the Planet without landing. Other still can do neither.

### 7.3. Skill Checks & Missions
In order to attemp a mission, your Personnel must be untapped and present at that location. For a Planet it means having Landed on it, while for a space location it needs to be on a Ship
at that Location.

- **Skill Check:**
   - Choose one personnel as the lead.
   - Reveal the top card of your deck to determine its D6 value (printed on every card).
   - Total: Skill value + D6 + any modifiers.
...
any relevant modifiers + D6). In the losing team, kill one random Personnel. On a tie, both teams lose.

Ship Combat: Do an opposed STR check using the highest STR in each Ship's crew + the Ship's WPN rating + D6. The losing Ship takes 1
damage. Ona tie, both Ships lose. If a Ship cannot take any more damage, it is **disabled**, and it will explode at the end of your next 
...
Ships that aren't meeint their crew requirements may not defend and take automatically damage. Ships with no crew requirements may defend,
...
- **Multi-Faction Deck Building:**  
  - Players may select primary and secondary factions, but must obey any faction mixing restrictions printed on cards.
- **Advanced Diplomacy/Infamy:**  
  - Cards or tokens may track repeated betrayals, granting special powers or penalties.
- **Expansions:**  
