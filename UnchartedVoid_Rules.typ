...
=== 3.2. Manufacts & Space Line
  ...
  - Both players select a set of manufact (artifact) cards for initial seeding—usually 6 each, for 12 total.
...
During this phase, do any number of the following actions, in any order:
  ...
  - Play Ships, Personnel, Manufacts (artifacts/equipment), Installations, or Event cards as allowed.
...
There are four resource types, corresponding to Installations:
  ...
  1. *Tech*: scientific and engineering prowess

  1. *Tactical*: military and strategic capability

  1. *Mystical*: psionics, mysticism, or unexplained forces
...
=== 6.1. Personnel
  ...
  - *Faction* (may affect deck building or card abilities)

  - *Cost* (resource requirement)

  - *Skills:* (Numeric ratings, e.g. Charisma, Intelligence, Strength, Weird)

  - *Text Box:* Special abilities, triggers (may include "Flash")

  - *D6 Value:* (1-6, for randomized checks)

  - *Other:* Hit points, roles, flavor text (optional)
...
Faction: Federation
Cost: 2 influence, 1 tactical
Skills: Charisma 4, Intelligence 3, Strength 2, Weird 0
Text: [Flash] When Captain Tallis is revealed during a skill check, draw a card.
D6 Value: 2
`
```
...
=== 6.2. Ships
  ...
  - *Range* (how far ship can move)

  - *Crew Requirement* (min \# of personnel)

  - *Armor/Weapons/Cargo* (if applicable)

  - *Text Box:* Abilities or effects
...
=== 6.4. Installations
  ...
  - *Type:* (choose from the four resources)
...
=== 6.5. Locations
  ...
  - *Mission:* (Skill[s] required, difficulty, rewards, victory points for completion)

  - *Text Box:* Special rules for the location
...
```
`Name: Mira's Rift
Mission: Science Skill 12 (must be completed across multiple turns; place a progress marker for each successful check of 4+)
Reward: 2 victory points, claim both manufacts from this location
Special: Ships at Mira's Rift have range -1
`
```
...
=== 7.4. Combat
  ...
  - Combat is generally resolved via opposed skill checks (e.g., attacker’s Strength + D6 vs. defender’s Strength + D6).

  - Damage, retreat, and capture are handled by card rules and outcomes.
